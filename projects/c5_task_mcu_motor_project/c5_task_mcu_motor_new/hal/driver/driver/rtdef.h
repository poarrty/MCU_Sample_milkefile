...
#define INIT_EXPORT(fn, level)                                                                                       \
    ...
    __declspec(allocate("rti_fn$f")) RT_USED const struct rt_init_desc __rt_init_msc_##fn  = {__rti_level_##fn, fn, __rti_##fn##_name};
#else
struct rt_init_desc {
    const char *    level;
    const init_fn_t fn;
...
#define INIT_EXPORT(fn, level)                                                                                      \
    const char                                                         __rti_level_##fn[] = level "__rt_init_" #fn; \
    __declspec(allocate("rti_fn$f")) RT_USED const struct rt_init_desc __rt_init_msc_##fn = {__rti_level_##fn, fn};
#endif
#else
#if RT_DEBUG_INIT
struct rt_init_desc {
