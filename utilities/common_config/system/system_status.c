...
INIT_PREV__EXPORT(system_status_init);
/*****************************************************************/
/**
...
uint8_t read_coredown(void) {
    fdb_kv_get_blob(&kvdb, "hardfault", fdb_blob_make(&blob, cStringBuffer, sizeof(cStringBuffer) + 1));
...
void wwdgtimeout_coredown_save(void) {
    ...
    // prvRunTimeStatsCommand(cStringBuffer+strlen(cStringBuffer), 2048-strlen(cStringBuffer), NULL);
...
static void SFU_BOOT_ManageResetSources(void) {
    ...
    switch (e_wakeup_source_id) {
        ...
        case SFU_RESET_OB_LOADER:
            TRACE("WARNING: A Reboot has been triggered by an Option Bytes reload!");
            /* WARNING: This might be generated by an attempted attack, a bug or your code!
               Add your code here in order to implement a custom action for this event,
               e.g. trigger a mass erase or take any other  action in order to
               protect your system, or simply discard it if this is expected.
        ...
        default:
            TRACE("WARNING: A Reboot has been triggered by an Unknown reset source!");
            /* WARNING: This might be generated by an attempted attack, a bug or your code!
               Add your code here in order to implement a custom action for this event,
               e.g. trigger a mass erase or take any other  action in order to
               protect your system, or simply discard it if this is expected.
...
static uint8_t sys_reboot_source(void) {
    ...
    switch (e_wakeup_source_id) {
        ...
        case SFU_RESET_OB_LOADER:
            printf("WARNING: A Reboot has been triggered by an Option Bytes reload!");

            break;

        default:
            printf("WARNING: A Reboot has been triggered by an Unknown reset source!");
