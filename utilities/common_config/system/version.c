 ...
 * @Others: None
 *******************************************************************************/
int version_init(void) {
    version_info_display();
    return 0;
}
INIT_ENV__EXPORT(version_init);
/******************************************************************************
...
SHELL_EXPORT_CMD(SHELL_CMD_PERMISSION(0) | SHELL_CMD_TYPE(SHELL_TYPE_CMD_FUNC), version_info_display, version_info_display, show version message);
