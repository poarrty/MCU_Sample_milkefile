...
static const char *shellText[] =
{
    ...
    [SHELL_TEXT_INFO] =
        ...
        "\033[32m| |    ___| |_| |_ ___ _ __   ___| |__   ___| | |\033[0m\r\n"
        "\033[32m| |   / _ \\ __| __/ _ \\ '__| / __| '_ \\ / _ \\ | |\033[0m\r\n"
        "\033[32m| |__|  __/ |_| ||  __/ |    \\__ \\ | | |  __/ | |\033[0m\r\n"
        "\033[32m|_____\\___|\\__|\\__\\___|_|    |___/_| |_|\\___|_|_|\033[0m\r\n"
        "\r\n"
        "\033[32mBuild:       "__DATE__" "__TIME__"\033[0m\r\n"
        "\033[32mVersion:     "SHELL_VERSION"\033[0m\r\n"
        "\033[32mCopyright:   (c) 2020 Letter\033[0m\r\n",
#endif
    [SHELL_TEXT_CMD_TOO_LONG] = 
        "\r\nWarning: Command is too long\r\n",
    [SHELL_TEXT_CMD_LIST] = 
        "\r\n\033[35mCommand List:\033[0m\r\n",
    [SHELL_TEXT_VAR_LIST] = 
        "\r\n\033[35mVar List:\033[0m\r\n",
    [SHELL_TEXT_USER_LIST] = 
        "\r\n\033[35mUser List:\033[0m\r\n",
    [SHELL_TEXT_KEY_LIST] =
        "\r\n\033[35mKey List:\033[0m\r\n",
...
static void shellWriteCommandLine(Shell *shell, unsigned char newline)
{
    ...
    if (shell->status.isChecked)
    {
        ...
        sprintf(string, "\033[32m%s\033[0m", shell->info.user->data.user.name);
        shellWriteString(shell, string);
        shellWriteString(shell, "\033[32m:\033[0m");
        shellWriteString(shell, shell->info.path ? shell->info.path : "\033[32m/\033[0m");
        shellWriteString(shell, "\033[32m$ \033[0m");
    }
    else
    {
