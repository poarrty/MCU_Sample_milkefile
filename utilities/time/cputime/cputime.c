#include "cputime.h"
#include "shell.h"
#include "cputime_cfg.h"

#define LOG_TAG "cputime"
#include "elog.h"
...
SHELL_EXPORT_CMD(SHELL_CMD_PERMISSION(0) | SHELL_CMD_TYPE(SHELL_TYPE_CMD_FUNC), clock_cpu_test, clock_cpu_test,clock_cpu_test 1000000);